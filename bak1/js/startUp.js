...
var routes = [];
var minMiles, maxMiles;
$(document).ready(function () {
    getRoutes();
    $('#startForm').submit(function () {
        var routeName = $('#routesSelect').val();
        var scaleFactor = $('#scaleSelect').val();
        //alert(scaleFactor);
        var mileStart, mileEnd, countyLine, interChange, rrXing, bridge, stream, signs, culv;
        countyLine = null;
        interChange = null;
        rrXing = null;
        bridge = null;
        ...
        //drawCanvas();
      // testDraw();
       drawCanvas(routeName,mileStart,mileEnd,scaleFactor,countyLine,interChange,rrXing,bridge,stream,signs,culv);
        $('#grayCover').hide();        
        $('#canvas1').toggle();
